...
The complete Tedim/Zomi Bible (Lai Siangtho) translated in 1932.
...
| [TXT - Merged (JSON + XML)](https://raw.githubusercontent.com/paumkim/zomi-dataset/main/data/tedim1932_merged.txt) | 7.8 MB | Combined from both sources, deduplicated |

## Source

The Bible text comes from two sources:
1. **Laisiangtho Scripture** — `tedim1932.json` (30,715 verses)
2. **Laisiangtho Core** — `tedim.xml` (same translation with book descriptions)

Both are the same 1932 Tedim translation. The merged version combines them
with duplicates removed.

## License

Public domain — published in 1932.
