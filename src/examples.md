...
|------|-----------|---------|
| Tuni | tu (this) + ni (day) | Today |
| Ziingsang | ziing (early/dark) + sang (morning) | early morning |
| ka thobaih hi | ka (I) + thobaih (woke up) + hi (is) | I woke up |
| Amaute tawh | amau (they) + te (plural) + tawh (with) | with them |
| gaamsungah | gaam (jungle) + sung (inside) + ah (in) | to the jungle |
| kapaai uh hi | ka (I) + paai (go) + uh (they/plural) + hi (is) | I went (with them) |
...
- `Tuaah` = Tua + `ah`
- `laamding` = laam + `ding`
- `laam` (dance, long vowel) ≠ `lam` (path, short vowel)
...
- `gaan` (animal, long vowel) ≠ `gan` (short form)
